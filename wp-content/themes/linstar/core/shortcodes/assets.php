...
class king_shortcode_assets {
	...
	public static function register() {
		...
		wp_localize_script( 'magnific-popup', 'su_magnific_popup', array(
				'close'   => __( 'Close (Esc)', KING_DOMAIN ),
				'loading' => __( 'Loading...', KING_DOMAIN ),
				'prev'    => __( 'Previous (Left arrow key)', KING_DOMAIN ),
				'next'    => __( 'Next (Right arrow key)', KING_DOMAIN ),
				'counter' => sprintf( __( '%s of %s', KING_DOMAIN ), '%curr%', '%total%' ),
				'error'   => sprintf( __( 'Failed to load this link. %sOpen link%s.', KING_DOMAIN ), '<a href="%url%" target="_blank"><u>', '</u></a>' )
			) );
		...
		wp_localize_script( 'king-options-page', 'su_options_page', array(
				'upload_title'  => __( 'Choose files', KING_DOMAIN ),
				'upload_insert' => __( 'Add selected files', KING_DOMAIN ),
				'not_clickable' => __( 'This button is not clickable', KING_DOMAIN )
			) );
		// Generator
		...
		wp_localize_script( 'king-generator', 'king_Shortcode_Generator', array(
				'upload_title'         => __( 'Choose file', KING_DOMAIN ),
				'upload_insert'        => __( 'Insert', KING_DOMAIN ),
				'isp_media_title'      => __( 'Select images', KING_DOMAIN ),
				'isp_media_insert'     => __( 'Add selected images', KING_DOMAIN ),
				'presets_prompt_msg'   => __( 'Please enter a name for new preset', KING_DOMAIN ),
				'presets_prompt_value' => __( 'New preset', KING_DOMAIN ),
				'last_used'            => __( 'Last used settings', KING_DOMAIN )
			) );
		// Shortcodes stylesheets
		wp_register_style( 'king-flex-slider-css', THEME_URI.'/css/flexslider.css', false, KING_VERSION, 'all' );
