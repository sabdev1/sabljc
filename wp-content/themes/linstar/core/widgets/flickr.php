...
class flickr_photos extends WP_Widget {
	...
	function flickr_photos() {
		...
		$this->WP_Widget( 'flickr','Flickr Photos', $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		$defaults = array( 'flickr_title' =>__( 'Flickr' , KING_DOMAIN), 'no_of_photos' => '6' , 'flickr_display' => 'latest', 'flickr_id'=>'', 'class' => '' );
