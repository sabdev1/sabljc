...
if ( ! class_exists( 'king_FILTER' ) ) {
    ...
    class king_RESET_FILTER_Widget extends WP_Widget {
        ...
        function __construct() {
            $widget_ops  = array( 'classname' => 'king-filter-ajax-reset-navigation king-filter-ajax-navigation woocommerce widget_layered_nav', 'description' => __( 'Reset all filters setted by DEVN Filter Widget', 'king' ) );
            $control_ops = array( 'width' => 400, 'height' => 350 );
            parent::__construct( 'king-filter-ajax-reset-navigation', __( 'DEVN Woo Reset Filter Widget', 'king' ), $widget_ops, $control_ops );
        }
        ...
        function form( $instance ) {
            ...
            $defaults = array(
                'title' => '',
                'label' => __( 'Reset All Filters', 'king' )
            );
            ...
            <p>
                <label>
                    <strong><?php _e( 'Button Label', 'king' ) ?>:</strong><br />
