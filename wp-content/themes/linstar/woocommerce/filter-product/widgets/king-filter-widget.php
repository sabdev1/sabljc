...
class king_FILTER_Widget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops  = array( 'classname' => 'king-filter-ajax-navigation woocommerce widget_layered_nav', 'description' => __( 'Filter products ajax widget!', 'king' ) );
        $control_ops = array( 'width' => 400, 'height' => 350 );
        parent::__construct( 'king-filter-ajax-navigation', __( 'DEVN Woo Filter Widget', 'king' ), $widget_ops, $control_ops );
    }
    ...
    function widget( $args, $instance ) {
        ...
        if ( count( $terms ) > 0 ) {
            ...
            elseif ( $display_type == 'select' ) {
                ...
                <a class="dev-filter-select-open" href="#"><?php _e( 'Filters List:', 'king' ) ?></a>
...
function form( $instance ) {
    ...
    <p>
        <label>
            <strong><?php _e( 'Title', 'king' ) ?>:</strong><br />
            <input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" value="<?php echo esc_attr( $instance['title'] ); ?>" />
        </label>
    </p>

    <p>
        <label for="<?php echo esc_attr( $this->get_field_id( 'attribute' ) ); ?>"><strong><?php _e( 'Attribute:', 'king' ) ?></strong></label>
    ...
    <p><label for="<?php echo esc_attr( $this->get_field_id( 'query_type' ) ); ?>"><?php _e( 'Query Type:', 'king' ) ?></label>
        <select id="<?php echo esc_attr( $this->get_field_id( 'query_type' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'query_type' ) ); ?>">
            <option value="and" <?php selected( $instance['query_type'], 'and' ); ?>><?php _e( 'AND', 'king' ); ?></option>
            <option value="or" <?php selected( $instance['query_type'], 'or' ); ?>><?php _e( 'OR', 'king' ); ?></option>
        </select></p>

    <p><label for="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>"><strong><?php _e( 'Type:', 'king' ) ?></strong></label>
        <select class="king_filter_type widefat" id="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'type' ) ); ?>">
            <option value="list" <?php selected( 'list', $instance['type'] ) ?>><?php _e( 'List', 'king' ) ?></option>
            <option value="color" <?php selected( 'color', $instance['type'] ) ?>><?php _e( 'Color', 'king' ) ?></option>
            <option value="label" <?php selected( 'label', $instance['type'] ) ?>><?php _e( 'Label', 'king' ) ?></option>
            <option value="select" <?php selected( 'select', $instance['type'] ) ?>><?php _e( 'Dropdown', 'king' ) ?></option>
        </select>
    </p>

    <p id="dev-filter-display" class="dev-filter-display-<?php echo esc_attr( $instance['type'] ); ?>">
        <label for="<?php echo esc_attr( $this->get_field_id( 'display' ) ); ?>"><strong><?php _e( 'Display (default All):', 'king' ) ?></strong></label>
        <select class="king_filter_type widefat" id="<?php echo esc_attr( $this->get_field_id( 'display' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'display' ) ); ?>">
            <option value="all"          <?php selected( 'all', $instance['display'] ) ?>>          <?php _e( 'All (no hierarchical)', 'king' ) ?></option>
            <option value="hierarchical" <?php selected( 'hierarchical', $instance['display'] ) ?>> <?php _e( 'All Hierarchical', 'king' ) ?>   </option>
            <option value="parent"       <?php selected( 'parent', $instance['display'] ) ?>>       <?php _e( 'Only Parent', 'king' ) ?>        </option>
        </select>
    </p>
