	...
	?>
		...
		<section id="related_posts">
			<div class="block-head">
				<h4 class="widget-title"><?php _e( 'Related Articles' , KING_DOMAIN ); ?></h4>
			...
			<div class="post-listing">
				...
				<div class="related-item col-md-4">
					<ul class="recent_posts_list">
						<li>
							<a href="<?php the_permalink(); ?>" title="<?php printf( __( 'Permalink to %s', KING_DOMAIN ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">
								<img src="<?php echo king_createLinkImage( $king->get_featured_image($post,false), '272x124xc' ); ?>" alt="<?php the_title(); ?>" />
								<span class="overlay-icon"></span>
							</a>
							<br />
							<a class="relate-link" href="<?php the_permalink(); ?>" title="<?php printf( __( 'Permalink to %s', KING_DOMAIN ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a>
