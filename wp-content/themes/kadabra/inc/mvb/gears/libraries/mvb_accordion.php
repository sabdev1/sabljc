...
class MVB_Accordion
{
    ...
    {
        return array(
            'title'           =>      __('Accordion module', 'dfd'),
            'description'     =>      __('Add an accordion', 'dfd'),
    ...
    public static function fields()
    {
        ...
        $the_fields = array(
            ...
            'accordion_panel' => array(
                'type'      =>      'repeater',
                'button'    =>      __('Add section', 'dfd'),
                'label'     =>      __('Section', 'dfd'),
                'lbl_d'     =>      __('Section Title', 'dfd'),
                'fields'    =>      array(
		    'icon' => array(
		        'type'      =>      'icon',
		        'label'     =>      __('Icon', 'dfd'),
			...
			'type'      =>      'text',
                        's_title'   =>      TRUE,
                        'label'     =>      __('Section Title', 'dfd'),
                        'col_span'  =>      'lbl_third'
                    ),

                    'content' => array(
                        'type'      =>      'textarea',
                        'label'     =>      __('Section content', 'dfd'),
                    ),
                )//end repeater_fields
            ),
