...
class MVB_Presentation_Boxes_Img
{
    ...
    {
        return array(
            'title'           =>      __('Presentation image', 'dfd'),
    ...
    public static function fields()
    {
        ...
        $the_fields = array(
		    ...
		    'show_title' => array(
			    'type'      =>      'select',
			    'label'     =>      __('Show title and subtitle in hover box', 'dfd'),
			    'help'      =>      __('The title and subtitle will be displayed in hover-box if YES is selected and under the image if NO', 'dfd'),
			    'default'   =>      1,
			    'options' => mvb_yes_no(),
			    'col_span'  =>      'lbl_half'
		    ),
