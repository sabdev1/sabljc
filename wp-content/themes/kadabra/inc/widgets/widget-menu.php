...
class DFDMenuWidget extends WP_Widget {
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('nav_menu'); ?>"><?php _e('Select Menu:', 'dfd'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('menu_direction'); ?>"><?php _e('Menu Direction:', 'dfd'); ?></label>
			<select id="<?php echo $this->get_field_id('menu_direction'); ?>" name="<?php echo $this->get_field_name('menu_direction'); ?>">
                <?php
