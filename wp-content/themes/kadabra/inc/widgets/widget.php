...
class SB_WP_Widget extends WP_Widget {
	...
	<p>
        ...
        <textarea class="widefat" id="<?php echo $input_id; ?>" name="<?php echo $input_name; ?>"><?php echo $value; ?></textarea>
    </p>
	<?php
	}
	...
	<p>
        <label for="<?php echo $input_id; ?>"><?php echo $label; ?></label>
        <input class="widefat" id="<?php echo $input_id; ?>" name="<?php echo $input_name; ?>" type="text" value="<?php echo $value; ?>" />
    </p>
	<?php
	}
	...
	<p>
        ...
        <select class="widefat" name="<?php echo $input_name; ?>" id="<?php echo $input_id; ?>">
            ...
            <option <?php selected( $value, $i ) ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
            <?php } ?>
        </select>
    </p>
	<?php
	...
	<p>
        <label for="<?php echo $input_id; ?>"><?php echo $label; ?></label>
        <input type="checkbox"  id="<?php echo $input_id; ?>" name="<?php echo $input_name; ?>" value="1" <?php checked( '1', $value ); ?> />&nbsp;
    </p>
	<?php
	}
	...
	protected function _input_wp_dropdown_categories($name) {
		...
		echo '<select id="'.$input_id.'" name="'.$input_name.'">';
	...
	protected function _input_wp_category_checklist($name) {
		...
		foreach ($categories as $cat) {
			...
			echo '<li><label><input type="checkbox" name="'.$input_name.'[]" value="'.$cat->slug.'" '.$checked.'/> '.$cat->name.'</label><li>';
		}
		echo '</ul>';
		echo '</p>';
	?>
