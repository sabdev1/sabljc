...
class crum_widgets_audio extends WP_Widget {
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'embed_url' ); ?>"><?php _e( 'Embed URL:', 'dfd' ); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('embed_width'); ?>"><?php _e('Embed width:', 'dfd'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('embed_description'); ?>"><?php _e('Embed Description:', 'dfd'); ?></label>
