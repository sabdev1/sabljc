...
class MVB_Words_From
{
    ...
    {
        return array(
            'title'           =>      __('Words from module', 'mvb'),
            'description'     =>      __('Add a words from section', 'mvb'),
    ...
    public static function render( $atts, $content = '' )
    {
        ...
        return $mvb_metro_factory->_load_view('html/public/mvb_words_from.php', $load);
    }//end render();
}//end class