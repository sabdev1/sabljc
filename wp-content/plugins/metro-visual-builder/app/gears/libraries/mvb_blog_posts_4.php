...
class MVB_Blog_Posts_4
{
    ...
    public static function fields()
    {
        ...
        $the_fields = array(
            ...
            'show_author' => array(
                'type'      =>      'select',
                'label'     =>      __('Display the Author', 'mvb'),
                'default'   =>      0,
                'options'   =>      mvb_yes_no(),
                'col_span'  =>      'lbl_half',
            ),
            ...
            'show_comments' => array(
                'type'      =>      'select',
                'label'     =>      __('Display the Comments', 'mvb'),
                'default'   =>      0,
                'options'   =>      mvb_yes_no(),
                'col_span'  =>      'lbl_half',
            ),
    ...
    public static function render( $atts )
    {
        ...
        return $mvb_metro_factory->_load_view('html/public/mvb_blog_posts_4.php', $load);
    }//end render();
}//end class