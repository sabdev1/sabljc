...
class MVB_Presentation_Boxes_Left_Icon
{
    ...
    {
        return array(
            'title'           =>      __('Presentation Boxes Left icon', 'mvb'),
            'description'     =>      __('Add a presentation box with left icon', 'mvb'),
...
//                    ),
    ...
    public static function render( $atts, $content = null )
    {
		...
		$load['few_rows'] = 1;
		$load['module_class'] = 'features_module_left_icon features_module-eq-height';
