...
class MVB_Text
{
    ...
    public static function fields()
    {
        ...
        $the_fields = array(
			...
			'separator-dropcaps' => array('type' => 'separator'),
			
			'dropcaps_enable' => array(
				'type'		=> 'select',
				'label'		=> __('Dropcaps Enable', 'mvb'),
				'options'	=> mvb_yes_no(),
				'col_span'	=> 'lbl_third',
			),
			'dropcaps_type' => array(
				'type'		=> 'select',
				'label'		=> __('Dropcaps Type', 'mvb'),
				'options'	=> self::dropcaps_types(),
				'col_span'	=> 'lbl_third',
			),
			'dropcaps_style' => array(
				'type'		=> 'select',
				'label'		=> __('Dropcaps Style', 'mvb'),
				'options'	=> self::dropcaps_styles(),
				'col_span'	=> 'lbl_third',
			),
	...
	public static function dropcaps_types() {
		return array(
			'single' => __('Single', 'mvb'),
			'rec' => __('Rec', 'mvb'),
			'round' => __('Round', 'mvb'),
		);
	}
	
	public static function dropcaps_styles() {
		return array(
			'dark' => __('Dark', 'mvb'),
			'red' => __('Red', 'mvb'),
		);
