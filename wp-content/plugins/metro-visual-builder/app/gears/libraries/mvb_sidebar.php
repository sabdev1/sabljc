...
class MVB_Sidebar
{
    ...
    {
        return array(
            'title'           =>      __('Sidebar', 'mvb'),
            'description'     =>      __('Add a sidebar', 'mvb'),
    ...
    public static function fields()
    {
        ...
        $the_fields = array(
            ...
            'sidebar' => array(
                'type'      => 'select',
                'label'     => __('Sidebar', 'mvb'),
				'help'      =>  __('Select sidebar', 'mvb'),
				'default'	=> 0,
				'options'	=> dfd_sidebar_list(),
				'col_span'  => 'lbl_full'
            ),
    ...
    public static function render( $atts, $content = null )
    {
        ...
        return $mvb_metro_factory->_load_view('html/public/mvb_sidebar.php', $load);
    }//end render();
