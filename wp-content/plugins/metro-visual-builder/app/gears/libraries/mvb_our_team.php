        ...
        $the_fields = array(
            ...
            'presentation_box' => array(
                ...
                'fields'    =>      array(
					...
					'thumbnail_transform' => array(
						'type'      => 'select',
						'label'     => __('Tumbnail Transform', 'mvb'),
						'help'      => __('Select one of appear effects for thubmnail', 'mvb'),
						'default'   => 0,
						'options'   => dfd_tumbnail_transform(),
						'col_span'  => 'lbl_half'
					),
                )//end repeater_fields
            ),
