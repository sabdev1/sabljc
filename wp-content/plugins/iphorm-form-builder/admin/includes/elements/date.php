                ...
                <div class="ifb-element-settings-inner">
                    <table class="ifb-form-table ifb-element-settings-form-table ifb-element-settings-more-form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <div class="ifb-tooltip"><div class="ifb-tooltip-content">
                                    <?php esc_html_e('The start year will be the first year in the year dropdown and every year from the start year to the end year will be displayed.', 'iphorm'); ?>
                                </div></div>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input type="checkbox" id="months_as_numbers_<?php echo $id; ?>" name="months_as_numbers_<?php echo $id; ?>" <?php checked(true, $element['months_as_numbers']); ?> onclick="iPhorm.monthsAsNumbers(this.checked, iPhorm.getElementById(<?php echo $id; ?>));" />
                        ...
                        <?php
                            if (!isset($element['date_format'])) $element['date_format'] = 'l, j F Y';
