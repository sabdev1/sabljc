                ...
                onComplete: function () {
                    if (!!window.grecaptcha) {
                        $('#fancybox-content .iphorm-recaptcha').each(function () {
                            ...
                            for (var i = 0; i < window.iPhorm.recaptchas.length; i++) {
                                if (window.iPhorm.recaptchas[i].uniqueId === id) {
                                    $container.empty();
                                    var recaptchaId = grecaptcha.render(window.iPhorm.recaptchas[i].uniqueId, window.iPhorm.recaptchas[i].config);
                                    $container.data('iphorm-recaptcha-id', recaptchaId);
                                }
                            }
                        });
                    }
